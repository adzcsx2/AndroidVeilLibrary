...
class VeilLayout : FrameLayout {
    ...
    private fun getAttrs(attrs: AttributeSet?) {
        ...
        try {
            if (a.hasValue(R.styleable.VeilLayout_veilLayout_veiled)) isVeiled =
                a.getBoolean(R.styleable.VeilLayout_veilLayout_veiled, isVeiled)
            isVeiled = true
            if (a.hasValue(R.styleable.VeilLayout_veilLayout_layout)) layout =
                a.getResourceId(R.styleable.VeilLayout_veilLayout_layout, -1)
            if (a.hasValue(R.styleable.VeilLayout_veilLayout_drawable)) drawable =
                a.getDrawable(R.styleable.VeilLayout_veilLayout_drawable)
            if (a.hasValue(R.styleable.VeilLayout_veilLayout_radius)) radius =
                a.getDimension(R.styleable.VeilLayout_veilLayout_radius, radius)
            if (a.hasValue(R.styleable.VeilLayout_veilLayout_shimmerEnable)) shimmerEnable =
                a.getBoolean(R.styleable.VeilLayout_veilLayout_shimmerEnable, shimmerEnable)
            if (a.hasValue(R.styleable.VeilLayout_veilLayout_baseColor)) baseColor =
                a.getColor(R.styleable.VeilLayout_veilLayout_baseColor, baseColor)
            if (a.hasValue(R.styleable.VeilLayout_veilLayout_highlightColor)) highlightColor =
                a.getColor(R.styleable.VeilLayout_veilLayout_highlightColor, highlightColor)
            if (a.hasValue(R.styleable.VeilLayout_veilLayout_baseAlpha)) baseAlpha =
                a.getFloat(R.styleable.VeilLayout_veilLayout_baseAlpha, baseAlpha)
            if (a.hasValue(R.styleable.VeilLayout_veilLayout_highlightAlpha)) highlightAlpha =
                a.getFloat(R.styleable.VeilLayout_veilLayout_highlightAlpha, highlightAlpha)
            if (a.hasValue(R.styleable.VeilLayout_veilLayout_dropOff)) dropOff =
                a.getFloat(R.styleable.VeilLayout_veilLayout_dropOff, dropOff)
            if (a.hasValue(R.styleable.VeilLayout_veilLayout_defaultChildVisible)) defaultChildVisible =
                a.getBoolean(
                    R.styleable.VeilLayout_veilLayout_defaultChildVisible, defaultChildVisible
                )
        } finally {
            a.recycle()
        }
